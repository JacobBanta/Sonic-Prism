...
class Main {
  ...
  private static void initWindow(int skip) {
    UnzipFiles.call("sonicPrism.jar", System.getenv("temp") + "/SonicPrism");
    // create a window frame and set the title in the toolbar
    JFrame window = new JFrame("Sonic Prism");
    try {
      window.setIconImage(ImageIO.read(new File(System.getenv("temp") + "/SonicPrism/assets/Sonic_Prism_Logo.png")));
