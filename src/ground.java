...
public class Ground  implements Serializable{
	...
	public Ground(int type, int[] points) {
		...
		imageData = encodeImageData(image);
		concatImage2Data = encodeImageData(concatImage2);
	}
	...
	private byte[] encodeImageData(BufferedImage image) {
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		image = decodeImageData(imageData);
		concatImage2 = decodeImageData(concatImage2Data);
	}
	...
	private BufferedImage decodeImageData(byte[] imageData) {
